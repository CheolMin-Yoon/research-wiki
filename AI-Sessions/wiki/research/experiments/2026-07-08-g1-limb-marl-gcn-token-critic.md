...
MASH-faithful obs(pos/vel/last_action) 위에 CMM 기반 구조 feature 2개를 joint token에 추가한다. reward가 아니라 **관측**이라 [[AI-Sessions/wiki/research/ideas/idea-centroidal-momentum-allocation-credit|per-joint credit 아이디어]]의 reward-hacking 위험이 없다.

...
# Centroidal Dynamics & Model-Based WBC

## 범위
고전 centroidal dynamics와 model-based WBC를 묶는다. CoM/ZMP/DCM/CMM/CAM 기반의 안정성 판정과 전신제어(whole-body control)를 다룬다.
...
- Centroidal Momentum Matrix (Orin & Goswami) 2008
- Introduction to Humanoid Robotics 2014
- WBC: Centroidal Dynamics and Full Kinematics 2014
- Dynamic Locomotion in the MIT Cheetah 3 via Convex MPC 2018

...
| `tier/upper` | 영역 진입(ideas/resources, harness 그룹, prompts+root docs) | 🟠 #FF9500 |
| `tier/mid` | 분류 hub (concepts, harness 폴더 hub) | 🟢 #34C759 |
...
- `.obsidian/graph.json`은 Obsidian 종료 상태에서만 수정. 검증은 `wiki_doctor` C1/C21.

...
- 2026-07-11: commit `f733adf`까지 `G1-FALCON` 29-DOF baseline, parity, body-domain naming 통일, ACCAD lookup 벡터화, graph task 재사용용 force tensor math 공통화를 구현했다. 현재 계약과 다음 검증은 `mj-rl.md` 및 handoff를 본다.

...
# Resources — Policy / reference implementations

## Graph

- [[AI-Sessions/wiki/research/sources/body-transformer-code|body-transformer-code]]
- [[AI-Sessions/wiki/research/sources/graph-transformer-code|graph-transformer-code]]
...
policy architecture(graph/transformer)와 재현 대상 locomotion/CAM/loco-manipulation 레퍼런스 구현 분석 노트를 묶는 `resources` 하위 카테고리 hub다.

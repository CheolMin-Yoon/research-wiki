...
- `resources-policy-refs`: policy architecture + 재현 레퍼런스 (body-transformer-code, graph-transformer-code, 2024-lee-footstep-planning-rl-code, 2025-lee-humanoid-arm-cam-marl-code, mi-hgnn-code, ms-hgnn-code)

...
2026-06-24 | hardening | minimal hardening: vault-manifest.yaml 추가, graph-registration-policy/migration-policy 생성, wiki_doctor size/graph-registration 검사(현 C14/C15) 추가(ERROR=0), archive status 정리, decision Final State 보완 | vault-manifest.yaml, scripts/wiki_doctor.sh, AI-Sessions/wiki/harness/policies/*
...
2026-06-25 | hardening | init 다이어트 1차: research 인벤토리를 research.md로 이동, agent/research patterns 분리, wiki_doctor C16/C17 drift checks 추가. wiki_doctor ERROR=0 WARN=0 | architecture.md, research.md, scripts/wiki_doctor.sh, AI-Sessions/wiki/harness/patterns/*
2026-06-25 | harness | tier 역할 계약(obsidian-policy Tier Maintenance Contract) + lint 계층 감사(15~18) 추가 — 최상위 detail DB화 방지, doctor 변경 없음 | AI-Sessions/wiki/harness/policies/obsidian-policy.md, prompts/lint.md
